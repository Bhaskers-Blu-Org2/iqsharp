define(["require", "exports", "./formatters/inputFormatter.js", "./formatters/gateFormatter.js", "./formatters/registerFormatter.js", "./process.js", "./constants.js"], function (require, exports, inputFormatter_js_1, gateFormatter_js_1, registerFormatter_js_1, process_js_1, constants_js_1) {
    "use strict";
    ...
    var JsonToHtmlEncoder = /** @class */ (function () {
        function JsonToHtmlEncoder() {
            var _this = this;
            /**
             ...
             */
            this.jsonToSvg = function (json) {
                var qubits = json.qubits, instructions = json.instructions;
                var _a = inputFormatter_js_1.formatInputs(qubits), qubitWires = _a.qubitWires, registers = _a.registers, svgHeight = _a.svgHeight;
                var _b = process_js_1.processInstructions(instructions, registers), metadataList = _b.metadataList, svgWidth = _b.svgWidth;
                var formattedGates = gateFormatter_js_1.formatGates(metadataList);
                var measureGates = metadataList.filter(function (_a) {
                    var type = _a.type;
                    return type === constants_js_1.GateType.Measure;
                });
                var formattedRegs = registerFormatter_js_1.formatRegisters(registers, measureGates, svgWidth);
    ...
    exports.JsonToHtmlEncoder = JsonToHtmlEncoder;
    ;
});
